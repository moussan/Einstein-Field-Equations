...
const Sidebar = ({ isOpen, toggleSidebar }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      path: '/calculate/exact-solutions',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside 
        className={`fixed top-0 left-0 h-full w-64 bg-background-paper shadow-dark-lg transform transition-transform duration-300 ease-in-out z-30 ${
      ...
      >
        ...
        <div className="p-4 border-b border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <button 
              onClick={toggleSidebar}
              className="text-text-primary hover:text-primary focus:outline-none md:hidden"
